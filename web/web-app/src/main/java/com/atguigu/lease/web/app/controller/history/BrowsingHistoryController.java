...
public class BrowsingHistoryController {
	...
	private Result<IPage<HistoryItemVo>> page(@RequestParam long current, @RequestParam long size) {
		...
		Long userId = LoginUserHolder.getLoginUser().getUserId();//在线程变量中，获取用户id
		IPage<HistoryItemVo> result =browsingHistoryService.pageHistoryItemVoByUserId(page,userId);
