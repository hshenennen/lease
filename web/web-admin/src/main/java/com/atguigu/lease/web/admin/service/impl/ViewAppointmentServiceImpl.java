...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
	...
	//分页查询预约信息
	@Override
	public IPage<AppointmentVo> pageAppointmentQueryVo(IPage<AppointmentVo> page, AppointmentQueryVo queryVo) {
		return viewAppointmentMapper.pageAppointmentQueryVo(page,queryVo);
	}
}
